...
@Service("wordsFiter")
public class SenstiveWordsFiter {
    public static String filePath = "E:/AIDEAworkspace/BackEndPro/src/main/java/com/aiit/filter/dictionary.txt";//敏感词库文件路径
    public static Set<String> words;
    public static Map<String,String> wordMap;
    public static int minMatchTYpe = 1;      //最小匹配规则
    public static int maxMatchType = 2;      //最大匹配规则
    static{
        SenstiveWordsFiter.words = readTxtByLine(filePath);
        addBadWordToHashMap(SenstiveWordsFiter.words);
    }
    ...
    public String fiteSenstiveWords(String text){
        Set<String> s = SenstiveWordsFiter.words;
        Map<String,String> map = SenstiveWordsFiter.wordMap;
        Set<String> set = SenstiveWordsFiter.getBadWord(text, 2);
        String newText = SenstiveWordsFiter.replaceBadWord(text,2,"*");
    ...
    public static void main(String[] args) {
        ...
        System.out.println("敏感词的数量：" + SenstiveWordsFiter.wordMap.size());
        String string = "太多的伤感情怀也许只局限于饲养基地 荧幕中的情节，主人公尝试着去用某种方式渐渐的很潇洒地释自杀指南怀那些自己经历的伤感。"
                + "然后法轮功 我们的扮演的角色就是跟随着主人公的喜红客联盟 怒哀乐而过于牵强的把自己的情感也附加于银幕情节中，然后感动就流泪，"
                + "难过就躺在某一个人的怀里尽情的阐述心扉或者手机卡复制器一个人一杯红酒一部电影在夜三级片 深人静的晚上，关上电话静静的发呆着。";
        System.out.println("待检测语句字数：" + string.length());
        long beginTime = System.currentTimeMillis();
        Set<String> set = SenstiveWordsFiter.getBadWord(string, 2);
        //输出后的文本
        String a = SenstiveWordsFiter.replaceBadWord(string,2,"*");
