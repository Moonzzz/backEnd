...
<body>
<div class="x-body">
    <form class="layui-form" action="<%=basePath%>membercenter.action?/update" method="POST" enctype="multipart/form-data">
        <input type="hidden" value="${item.id}" name="memberid">
        <input type="hidden" value="${item.imgsrc}" name="imgsrc">
        <div class="layui-form-item">
            <label for="L_email" class="layui-form-label">
                <span class="x-red">*</span>图片
            </label>
            <div class="layui-input-inline">
                <input type="file" id="M_Image" name="image" required=""
                        autocomplete="off" class="layui-input">
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">*</span>请上传后缀为gif或jpg格式的图片
            </div>
        </div>
        <div class="layui-form-item">
            <label for="L_email" class="layui-form-label">
