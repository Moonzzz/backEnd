            ...
            <li>
                <div class="layui-field-box">
                    <div class="comment_user">
                        <a href="reply.html"><img alt="user" class="user_pic"
                                                  src="<%=filePath%>${reply.memberImage}"></a>
                    </div>
                    <div class="comment_content">
                        <p class="user_txt"><a href="reply.html">${reply.memberName}</a></p>
                        <p class="comment_txt">${reply.content}</p>
                        <div class="comment_bottom">
                            <p class="comment_time">${reply.datePublished}</p>
                            <p class="reply_btn">回复</p>
                            <p class="comment_like"><a class="click_like" id="comment_${reply.replyId}"><i
                                    class="layui-icon layui-icon-dianzan"></i><b
                                    class="comment_likeNum">${reply.likeNum}</b></a></p>
                        </div>
                    </div>
                </div>
            </li>
...
<form id="addReply" action="<%=basePath%>reply/addReply.action">
...
<script type="text/javascript">
    ...
    $(window).bind('beforeunload', function () {
        if (Object.keys(uploadLikeNums).length)
            $.ajax({
                type: "get"
                , url: "<%=basePath%>reply/updateLike.action"
